...
const data = servicesDataMap["flooring"]!;
const canonicalUrl = "https://www.progressinteriordesigns.com/services/flooring";

const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  serviceType: "Hardwood, Natural Stone & Architectural Flooring Installation",
...
export const Route = createFileRoute("/services/flooring")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: data.heroSubheadline },
      {
        name: "keywords",
        content:
          "hardwood flooring installation Kansas City, engineered hardwood flooring, large format Italian porcelain tile, luxury flooring contractor",
      },
